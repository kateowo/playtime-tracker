...
execute if score @s kate_store.playtime matches 1.. run title @s actionbar ["",{"text":"[","color":"dark_gray"},{"text":"⌚","color":"gold"},{"text":"] ","color":"dark_gray"},{"score":{"name":"@s","objective":"t_playtime_d_0"}},{"score":{"name":"@s","objective":"v_playtime_d_total"}},":",{"score":{"name":"@s","objective":"t_playtime_h_0"}},{"score":{"name":"@s","objective":"v_playtime_h_total"}},":",{"score":{"name":"@s","objective":"t_playtime_m_0"}},{"score":{"name":"@s","objective":"v_playtime_m_total"}},":",{"score":{"name":"@s","objective":"t_playtime_s_0"}},{"score":{"name":"@s","objective":"v_playtime_s_total"}}]